...
and exports approved claims as a payroll-ready file.
...
*assumed*
- Each claim carries one of a fixed set of categories — Travel, Meals,
Lodging, and Other. *assumed*
...
exported); there is no separate email/SMS channel. *assumed*
...
1. Who assigns each employee's manager, and where does that reporting-line
 data come from — is it entered directly in this system, or does it need to
 come from an existing HR/directory source?
